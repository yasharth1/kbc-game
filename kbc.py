...
def first():
  ...
  answer = inputtime("a)Draupadi Murmu", 0, 45)
...
def sixth():
  ...
  winsound.PlaySound("sounds/timer.wav", winsound.SND_LOOP + winsound.SND_ASYNC)
  answer = inputtime("b)Tata Projects", 10000, 60)
...
def seventh():
  ...
  winsound.PlaySound("sounds/timer.wav", winsound.SND_LOOP + winsound.SND_ASYNC)
  answer = inputtime("b)Somnath Sharma", 10000, 60)
...
def eighth():
  ...
  winsound.PlaySound("sounds/timer.wav", winsound.SND_LOOP + winsound.SND_ASYNC)
  answer = inputtime("a)Dead Sea", 10000, 60)
...
def ninth():
  ...
  winsound.PlaySound("sounds/timer.wav", winsound.SND_LOOP + winsound.SND_ASYNC)
  answer = inputtime("a)Black Holes", 10000, 60)
...
def tenth():
  ...
  time.sleep(1)
  print("The person shown in this picture was the former president of which country?")
  time.sleep(3)
  image = cv.imread("lbj.jpg")
  cv.imshow("Press any key to exit", image)
  cv.waitKey(0)
  cv.destroyAllWindows()
  print("a)Australia b)United States of America c)France d)Canada")
  winsound.PlaySound("sounds/timer.wav", winsound.SND_LOOP + winsound.SND_ASYNC)
  answer = inputtime("b)United States of America", 10000, 60)
  check_ans(answer, 40000, 10000, 20000, "b", "b)United States of America", "d)Canada", "b)United States of America", 60, 10)
tenth()
...
def thirteenth():
  ...
  time.sleep(0.25)
  print("Around 300 Indian soldiers were also evacuated as part of Operation Dynamo by the Allies in World War II, from which place in the north of France?")
  time.sleep(1)
  print("a)Dunkirk b)Normandy c)Calais d)Lyon")
  winsound.PlaySound("sounds/1250000ques.wav", winsound.SND_LOOP + winsound.SND_ASYNC)
  input13 = input("Enter your Answer ").lower()
  check_ans(input13, 2500000, 320000, 1250000, "a", "a)Dunkirk", "b)Normandy", "a)Dunkirk", None, 13)
thirteenth()
def fourteenth():
  time.sleep(2)
  ...
  time.sleep(0.25)
  print("Which of these institutes maintains the National Digital Library of India?")
  time.sleep(1)
...
def fifteenth():
  ...
  if confirm == "y":
    check_ans(answer, "1 crore", 320000, 5000000, "d", "c)Shah Bano case", "d)Kesavananda Bharati Case", "d)Kesavananda Bharati Case", None, 15)
  else:
    fifteenth()
fifteenth()
def sixteenth():
